...
<li><a href="#sec-5">5. Using an existing R2GUESS run</a></li>
<li><a href="#sec-6">6. Expanding</a></li>
<li><a href="#sec-7">7. Plotting</a>
<ul>
<li><a href="#sec-7-1">7.1. <span class="todo TODO">TODO</span> separate vignette, including vagaries of ggplot</a></li>
</ul>
</li>
<li><a href="#sec-8">8. Parallelism</a></li>
</ul>
</div>
</div>
...
demonstration as there is limited strong LD in this dataset.
    ...
    run.bvs(X,Y,gdir=mydir,backend="guess",tag.r2=0.8,guess.command="GUESS")
...
1.  TODO Which SNPs were selected as tags, esp in relation to causal variants?  Which SNPs come up in the GUESS results?

# Using an existing R2GUESS run<a id="sec-5" name="sec-5"></a>
...
## TODO separate vignette, including vagaries of ggplot<a id="sec-7-1" name="sec-7-1"></a>

# Parallelism<a id="sec-8" name="sec-8"></a>
