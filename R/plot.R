...
##'
##' The positions in the df.snps object are used to align the snps to
##' the correct coordinates.
##' @title ggld
##' @param data object of class SnpMatrix from which LD will be calculated 
##' @param df.snps data.frame generated by guess.summ
##' @return ggplot output
##' @author Chris Wallace
ggld <- function(data, df.snps) {
use <- !duplicated(df.snps$snpnum)
snps.num <- structure(df.snps$snpnum[use],names=df.snps$snp[use])
...
##'
##' @title addlines
##' @param summ data.frame generated by guess.summ
